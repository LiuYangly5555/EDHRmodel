...
% This program is used to simulate the sap flow over time in HA1
...
%--------------------------------
% Calculate plant axial, circuferential, and radial resistance (HA1)
...
sim=Flow_HA1(SWCr, SWCs, a,n, Ks, l, SWCfc, ...
...
writetable(sim_table, 'HA1.xlsm', 'sheet', 1)
