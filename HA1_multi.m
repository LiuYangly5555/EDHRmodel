...
% Shallow soil is sandy loam, deep soil is silt

%--------------------------------
% Set soil characteristic parameters
SWCr1=0.065; SWCs1=0.41; a1=0.075; n1=1.89; Ks1=106.1; l=-1; SWCfc=0.1218; % Sandy loam soil of the shallow layer
SWCr2=0.034; SWCs2=0.46; a2=0.016; n2=1.37; Ks2=6; % Silt soil of the deep layer
%--------------------------------
...
sim=Flow_Multi_HA1(SWCr, SWCs, a,n, Ks, l, SWCfc, ...
...
writetable(sim_table, 'HA1 data.xlsm', 'sheet', 5)
