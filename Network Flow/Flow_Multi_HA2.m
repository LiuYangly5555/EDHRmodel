function obj = Flow_Multi_HA2(SWCr1, SWCs1, a1, n1, Ks1,...
    SWCr2, SWCs2, a2, n2, Ks2, l, SWCfc, ...
    D1, D2, S, R, l_s, l_d, ln_s, ln_d, ...
     Hleaf, RH, T, Va, day)

 % The meaning of all codes is similar to Flow_HA2.m
      ...
      for i=1:1:144*day
          ...
          syms q1 q2 q3 p1 p2 p3;                                                
                     ...
                     eqns = [-q1*(2*obj.Rrs1(i, 1)+2*Rr_s+Ra_r1)+p1*Rc_r+q2*(2*obj.Rrs1(i, 1)+2*Rr_s+Ra_r1)==0,...
                        ...
                        (obj.H2(i, 1)-D1-D2/2)-q3*(obj.Rrs2(i, 1)+Rr_d+Ra_r2+Ra_s2/2)-(q3-p3)*(Ra_s2/2+Ra_b2)-Hleaf(i, 1)==0,...
                        (obj.H2(i, 1)-D1-D2/2)-q3*(obj.Rrs2(i, 1)+Rr_d+Ra_r2+Ra_s2/2)-p3*Rc_s2+(q2-p1)*(Ra_r1+Ra_s1)+q2*(2*obj.Rrs1(i, 1)+2*Rr_s+Ra_r1)-(obj.H1(i, 1)-D1/2)==0,...
                        (obj.H1(i, 1)-D1/2)-q1*(2*obj.Rrs1(i, 1)+2*Rr_s+Ra_r1)-(q1+p1)*(Ra_r1+Ra_s1)-(q1+p1+p2)*(Ra_s1+2*Ra_b1)-Hleaf(i, 1)==0];
